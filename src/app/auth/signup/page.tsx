  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-[#1A1D27] border border-[#2D3748] rounded-2xl p-8">
        ...
        <p className="text-sm text-[#64748B] mb-8">Start scoring custom cricket matches</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-white text-gray-700 font-medium rounded-xl hover:bg-gray-100 transition-colors"
          >
        ...
        <div className="mt-6 text-center text-sm text-[#64748B]">
          ...
          <Link href="/auth/login" className="text-[#10B981] hover:text-[#34D399] font-semibold">
            Sign in
          </Link>
        </div>
      </div>
